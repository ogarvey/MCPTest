...
- `FORGA.FAM` second-table names are not unique; probing code must group duplicates and pick a match intentionally instead of assuming dictionary uniqueness.
